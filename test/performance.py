...
from xopto.mcml.test import validate
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='MCML performance test')
    ...
    options = {
        ...
        'options': mc_options,
        'exportsrc': os.path.join(USER_TMP_PATH, 'mcml_performancetest.h')
    }
    ...
    print('--------------------------------------------------------------------------')
    print('       5.7 s - NVIDIA Corporation GeForce, RTX A6000\n'
          '               (Ubuntu 20.04, 460.73) GPU @ 1700 MHz')
    print('       7.4 s - NVIDIA Corporation GeForce, ASUS GF RTX 2080 TI STRIX\n'
          '               (Ubuntu 20.04, 460.80) GPU @ 1900 MHz')
    print('      15.2 s - NVIDIA Corporation GeForce, ASUS GF GTX 1080 TI STRIX\n'
          '               (Windows 8.1) GPU @ 1900 MHz')
    print('      26.8 s - NVIDIA Corporation GeForce, ASUS GF GTX 1070 OC\n'
    ...
    print('     357.7 s - Intel(R) Corporation Intel(R) HD Graphics 4600')
