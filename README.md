...
|------------------------------------------------------------------------------------------------------------|--------|---------|--------------|-------|-------|
| [xopto/pyxopto-intel-jupyter](https://hub.docker.com/repository/docker/xopto/pyxopto-intel-jupyter)        | v0.2.2 | 0.2.2   | Ubuntu 20.04 | -     | -     | 
| [xopto/pyxopto-nvidia-jupyter](https://hub.docker.com/repository/docker/xopto/pyxopto-nvidia-jupyter)      | v0.2.2 | 0.2.2   | Ubuntu 20.04 | 11.03 | 8     |
| [xopto/pyxopto-nvidia-jupyter-dl](https://hub.docker.com/repository/docker/xopto/pyxopto-nvidia-jupyter-dl) | v0.2.2 | 0.2.2   | Ubuntu 20.04 | 11.03 | 8     |
