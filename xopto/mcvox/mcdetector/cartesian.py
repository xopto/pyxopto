...
from xopto.mcvox.mcdetector.radial import Radial
...
class Cartesian(Detector):
    ...
    def cl_type(mc: mcobject.McObject) -> cltypes.Structure:
        ...
        class ClCartesian(cltypes.Structure):
            ...
            struct: cltypes.Structure
                A structure type that represents the Cartesian detector in
    ...
    def __init__(self, xaxis: axis.Axis or 'Cartesian',
    ...
    def radial(self, raxis: axis.Axis, order: int = 2, nfi: int = 360,
               center: Tuple[float, float] = (0.0, 0.0)) -> Detector:
        '''
        ...
        Returns
        -------
        radial: xopto.mcvox.mcdetector.base.Detector
