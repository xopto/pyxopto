...
class UniformFiber(Source):
    ...
    def cl_implementation(mc: mcobject.McObject) -> str:
        ...
        return '\n'.join((
            ...
            '	transform_point3f(&transformation, &pt_src, &packet_direction);',
            '',
            '	mc_point3f_t source_direction = source->direction;',
            '',
            '	if (mcsim_sample_box_contains(mcsim, &pt_mc)) {',
            '		mc_reverse_fpv3(&source_direction, &source_direction);',
            ...
            '				mc_dot_point3f(&normal, &packet_direction),',
    ...
    @classmethod
    def fromdict(cls, data: dict) -> 'UniformFiber':
        '''
