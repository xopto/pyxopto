...
class Nbk7(Absorption):
    material = 'nbk7'

    def __init__(self):
        '''
        Absorption data from SCOTT:
        https://www.schott.com/shop/advanced-optics/en/Optical-Glass/SCHOTT-N-BK7/c/glass-SCHOTT%20N-BK7%C2%AE
        '''
        super().__init__()
        filename = os.path.join(
            DATA_PATH, 'materials', 'absorption', 'nbk7_absorption.npy')
    ...
    def __call__(self, wavelength: float or np.ndarray, t: float = None) \
            -> np.ndarray or float:
        '''
        Computes the absorption coefficient of NBK7 glass.
