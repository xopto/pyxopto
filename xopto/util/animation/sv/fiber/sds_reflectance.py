...
def sv_fiber_distance(filename: str, config: dict = None,
    ...
    configuration as a function of the distance between the source and
    detector fiber.
    ...
    for index, sds in enumerate(config['fiber_sds']):
        if verbose:
            print('Processing fiber reflectance SDS {:.1f} um; {}/{}'.format(
                sds*1e6, index + 1, N))
...
if __name__ == '__main__':
    ...
    common.main(sv_fiber_distance, common.create_sv_animation_xz,
