...
.. note::
    ...
    The first and last accumulator of the detectors along each axis will also
    collect/accumulate the weights of photon packets that exceed the lower
    and upper limit of the corresponding axis.
...
.. note::
  ...
  The acceptance cone is applied after the photon packet leaves the sample and
  is refracted into the surrounding medium.
