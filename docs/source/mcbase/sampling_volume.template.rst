...
photon packets see :ref:`Trace <{{ MC }}-trace-label>`.
...
the :py:meth:`xopto.{{ MC }}.mc.Mc.sampling_volume` method of the Monte Carlo
...
conveniently imported into the :py:mod:`xopto.{{ MC }}.mcsv` and
...
:py:class:`xopto.{{ MC }}.mc.Mc` (:code:`mc_obj`) and a trace
(:code:`trace_obj`) that was produced by this simulator instance, a call
to the :py:meth:`~xopto.{{ MC }}.mc.Mc.sampling_volume` of the simulator
