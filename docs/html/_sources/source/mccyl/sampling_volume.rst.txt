...
photon packets see :ref:`Trace <mccyl-trace-label>`.
...
the :py:meth:`xopto.mccyl.mc.Mc.sampling_volume` method of the Monte Carlo
...
conveniently imported into the :py:mod:`xopto.mccyl.mcsv` and
:py:mod:`xopto.mccyl.mc` modules. 
...
:py:class:`xopto.mccyl.mc.Mc` (:code:`mc_obj`) and a trace
(:code:`trace_obj`) that was produced by this simulator instance, a call
to the :py:meth:`~xopto.mccyl.mc.Mc.sampling_volume` of the simulator
